        ...
        {showCore && (
          <>
            ...
            <NavLink to="/student/browse-internships" className={linkClass} end>
              <span className="text-[13px] font-bold">Browse Internships</span>
            </NavLink>
            <NavLink to="/student/my-applications" className={linkClass} end>
              <span className="text-[13px] font-bold">My Applications</span>
            </NavLink>
          </>
        )}

        <NavLink to="/student/credits" className={linkClass} end>
          <span className="text-[13px] font-bold">Credits</span>
        </NavLink>
