...
const StudentNavBar = () => {
  ...
  const navLinkClass =
    "px-4 py-2.5 rounded-[14px] text-[13px] font-bold text-[#333] hover:bg-[#f9f9f9] transition-colors no-underline tracking-wide";
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-5">
        <div className="flex flex-wrap items-center gap-2 md:gap-3 text-sm font-medium flex-1">
          <Link
            ...
            className="text-[23px] font-black tracking-tighter text-[#333] mr-6 whitespace-nowrap no-underline flex items-center"
          >
            InternStatus
          ...
          {showCore && (
            <div className="flex flex-wrap items-center gap-1 border-l border-[#e5e5e5] pl-6">
              <Link to="/student/dashboard" className={navLinkClass}>
                Dashboard
              </Link>
              <Link to="/student/browse-internships" className={navLinkClass}>
                Browse
              </Link>
              <Link to="/student/my-applications" className={navLinkClass}>
                Applications
              </Link>
            </div>
          )}
          ...
          <div className="flex flex-wrap items-center gap-3 ml-auto lg:ml-6">
            <Link to="/student/credits" className={navLinkClass}>
              Credits
            </Link>
